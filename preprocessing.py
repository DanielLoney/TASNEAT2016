...
class Methods:
    ...
    def standardise(possible):  # This probably shouldn't be as static method
        ...
        for idx, options in enumerate(possible):
            ...
            elif 'other' and 'at_home' in options:

                return_list[idx] = ['at_home', 'health', 'teacher', 'services', 'other']
...
class Preprocessing:
    ...
    @staticmethod
    def preprocess_outputs_1(path, method):
        ...
        if method == 0:
            for student in integer_list:
                ...
                return_integer_list.append(student_input)

            return return_integer_list #for integer results
            ...
            return Methods.lengthen(return_integer_list)#for results in binary
            ...
            return Methods.lengthen(return_integer_list) #For tally numbers
...
#print(Preprocessing.preprocess_outputs_1(path,1))
